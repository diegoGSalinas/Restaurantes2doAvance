...
<html lang="es">
    ...
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/CSS/carritostyle.css" />
                ...
                <div class="datos-usuario">
                    <c:choose>
                        <c:when test="${not empty usuario}">
                            ...
                            <p><strong>Prioridad:</strong> ${usuario.prioridad}</p>
                        </c:when>
                        <c:otherwise>
            ...
            <div class="seccion-carrito">
                ...
                <div id="compraExitosa" class="modal">
                    ...
                    <div style="text-align: center; margin-top: 20px;">
                        ...
                        <!--                        <a href="ControladorCarrito?accion=generarPDF" class="btn-descargar" style="text-decoration: none;">
                                                    Descargar Voucher
                                                </a>-->
